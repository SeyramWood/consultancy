      ...
      <div className="container  text-center">
        <div className="row p-3">
          ...
          <div className="col-lg-6 mb-5 col-sm-12  ">
            ...
            <div className="p-3 border">
              <h3 className="text-left">Annual Lecture</h3>
            </div>
          </div>
          <div className="col-lg-6 mb-5 col-sm-12  ">
            <div className="border">
            ...
            <div className="p-3 border">
              <h3 className="text-left">Advocacy</h3>
            </div>
          </div>
        ...
        <div className="row">
          <div className=" p-4">
            ...
            <p>Annual celebration of African diplomacy (rotates in different African countries
              ...
              Fellows into the African Diplomatic Academy (FADA).
            </p>
            <p>
              Afro-global bi-annual conference bringing together academics, diplomats, policy makers, corporate executives, students, etc to share research /practical
              experiences, exhibit products and new discoveries including books and to
              network.
            </p>
            <p>
              African Review of Diplomacy (yearly peer reviewed academic journal aimed
              at privileging Afrocentric epistemology in the global knowledge production
              complex)
            </p>
            <p>
            ...
            <p>
              ...
              foreign policy responses, negotiations, etc.
            </p>
          </div>
        </div>
