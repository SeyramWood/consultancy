    ...
    return (  
        ...
        <div className="col-12">
            <div className="row text-center">
                ...
                <div className="col-12">
                    <h3 className="text-green text-center "> AFRICAN YOUTH CULTURES</h3>
                    <img src="template/img/img/book4.jpeg" className="border img-fluid " style={{height:"450px",width:"60%"}} alt="img" />
                </div>
                <div className="p-3">
                   <p>
                  ...
                  <a href="https://www.amazon.com/African-Youth-Cultures-Globalized-World/dp/113809238X">
