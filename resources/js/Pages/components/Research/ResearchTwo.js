        ...
        <div className="col-12">
          <div className="row">
            <div className="col-12 text-center">
              <h3 className="text-green text-center ">LIBRERAL DEMOCRACY AND CIVIL SOCIETY FROM  FROM “BELOW” IN GHANA</h3>
              {/* <img src="template/img/img/at1.jpeg" className="img-fluid" style={{ height: "450px" }} alt="img" /> */}
            </div>
            <div className="col-12 pt-4">
              <p>
                Taking an integrative perspective of Gramsci's theory of the state, hegemony, civil society, subaltern class and the philosophy of praxis, this chapter raises some of these question as a point of entry, to challenge the liberal consensus on the much-touted democratic consolidation in Ghana and the role of civil society thereof: Which democratic transition has occurred, and is being consolidated and celebrated in Ghana? Who are the losers and winners in this change? Which democratic transition is yet to occur in the world of the subaltern class in Ghana? What type of “civil society” can bring about and consolidate this “other” democratic transition?
              </p>
              <p>
