      ...
      <div className="container-fluid ">
        <div className="container">
          ...
          <div className="mt-4 pt-3 mb-5">
            ...
            <p>
              The Centre aims to serve as a hub in providing cutting edge scholarly research and
              training, as well as promote public engagement on global policy issues using
              multidisciplinary perspectives
              and approaches to contribute towards the implementation of
              effective policies on various aspects of Africa’s global and diplomatic relations. In so
              doing, the Centre will aim to build networks across Africa, focusing on key countries
              such as Ghana, Nigeria, South Africa, Kenya, Egypt, and organizations such as AU,
              Ecowas, and the UN. It will Identify areas of common Africa interest in relations to the
              rest of the world, and position Africa as a place of new and exciting opportunities for
              business and investment. The Centre will also offer practical training to public and
              private sector agencies in diplomacy,
          ...
          <div className="mb-5">
            <p>
              To achieve the above, the Centre will deploy research to promote a robust response
              to the myriad of challenges of the 21st Century global environment. In doing so, the
              Centre will contribute to the development and promotion of policy options on any given issue of foreign and diplomatic relationships. Academic publications will be a core
              activity of the Centre to contribute to international scholarship on Africa’s global and
              diplomatic relations. Conferences and symposia will enable the Centre to share and
              exchange its projects with broader intellectual and policy communities in the broad
              areas of international relations, foreign policy and diplomacy, and security.
            </p>
          </div>
          <div className="mb-5">

            <p>
              The Centre will also provide avenues for internship and practical training for both current students and recent graduates as its contribution to the training and development
              of critical human resources for various Ministries, Agencies and Departments (MDAs)
              across Africa. It will provide a resource Centre for researchers and policy makers across
              the African continent to engage critically in policy debates and decisions. It will serve
              as an advisory body to public and private organizations in the field of global and diplomatic relations.
            </p>
            <p>
              The Centre will be dedicated to developing practical and accessible training resources
              for the wider African publics to draw on. The aim is to develop innovative approaches
              that challenge existing inefficiencies and ineffectiveness with a particular focus on
              promoting understanding and appreciation of the changing global context. Besides, the
              Centre will focus keenly on the business environment including the role of multinational corporations, foreign direct investment by conducting relevant research which will
              be useful for policy makers as well as other stakeholders both within and outside the
              African continent.
            </p>
            <p>
              The long-term focus of the Centre includes the mentoring of emerging scholars around
              foreign policy and diplomacy. Through this mentoring process, particular emphasis and
              value will be placed on bringing together traditional and emerging knowledge to create state of the art methodologies and practices designed to maximize impact. The
              mentoring of emerging researchers through the Centre will generate new knowledge,
              innovative solutions and position our country appropriately as a regional leader within
